...
class DeviceOxidizedView(ObjectView):
    """Oxidized tab view for Device detail pages."""
...
@register_model_view(VirtualMachine, "oxidized", path="oxidized")
class VMOxidizedView(ObjectView):
    """Oxidized tab view for Virtual Machine detail pages."""

    queryset = VirtualMachine.objects.all()
    template_name = "netbox_oxidized/vm_tab.html"
    tab = ViewTab(
        label="Oxidized",
        weight=9100,
